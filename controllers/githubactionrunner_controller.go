...
//		for _, pod := range podRunnerPairs.podList.Items {
//			logger.Info("Pods not in sync", "Pods", pod.Name, "Status", pod.Status.Phase)
//		}
//		for _, runner := range podRunnerPairs.runners {
//			logger.Info("Runners not in sync", "Runner", runner.Name, "Status", runner.Status)
//		}
